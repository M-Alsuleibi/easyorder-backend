...
export class CreateTenantAndUserRoleTables1759427316617 implements MigrationInterface {
    name = 'CreateTenantAndUserRoleTables1759427316617'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."user_roles_role_enum" AS ENUM('admin', 'customer')`);
